...
namespace Restaurant.Persistence.Implementations.Repositories
{
    ...
    public class EmailNotification : IEmailNotification
    {
        ...
        public async Task<Response> SendBookingEmailAsync(ReservationVM model, bool isReminderEmail = false)
        {
        ...
        public async Task<Response> SendCheckInEmailAsync(DiningTableWithTimeSlotVM model)
        {
        ...
        private string GetCheckInEmailBody(string firstName, string lastName, RestaurantReservaitonDetail reservationDetails)
        {
            return $$"""
                    <!DOCTYPE html>
                    <html>
        ...
        private string GetBookingEmailBody(ReservationVM model, RestaurantReservaitonDetail reservationDetails, bool isReminderEmail)
        {
